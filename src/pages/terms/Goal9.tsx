		...
		<main dir="rtl" className="min-h-screen bg-white  md:text-xl">
			<section className="max-w-3xl h-full flex flex-col  mx-auto p-4 gap-4">
				<div className=" h-fit flex justify-between items-center w-full p-4 rounded-lg">
					<h1 className="text-orange-500 text-3xl md:text-4xl font-bold flex flex-col  gap-4 py-12">
						<p> الهدف التاسع</p>
						<p>{goalNames[9]}</p>
					</h1>
					<img
						src="/src/assets//images/goal9.jpg"
				...
				<div className="flex flex-col gap-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-2">
						<div className="bg-white shadow-lg p-6 rounded-xl border-r-8 border-orange-800 flex flex-col gap-3">
							<h2 className="text-3xl font-bold text-gray-800 bg-orange-50 py-4 pr-4 rounded-lg">
								عنوان
							</h2>
